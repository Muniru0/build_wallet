    ...
    //NOTE: BEFORE THE FOLLOWING STEPS YOU SHOULD HAVE ALREADY GOTTEN FUNDS FROM THE FAUCET.
    const addrObj = bitcoin.payments.p2pkh({pub:keyPair.publicKey, network: network});

    // this should get you the test funds from the faucet
    const myTestnetAddr = addrObj.address
